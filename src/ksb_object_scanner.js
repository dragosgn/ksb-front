...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("@tensorflow/tfjs"))
    : typeof define === "function" && define.amd
    ? define(["exports", "@tensorflow/tfjs"], factory)
  ...
  var ObjectDetection = (function() {
    function ObjectDetection(base) {
      this.modelPath = "" + BASE_PATH + base + "/tensorflowjs_model.pb";
      this.weightPath = "" + BASE_PATH + base + "/weights_manifest.json";
    }
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              _a = this;
              return [4, tf.loadFrozenModel(this.modelPath, this.weightPath)];
            case 1:
              _a.model = _b.sent();
